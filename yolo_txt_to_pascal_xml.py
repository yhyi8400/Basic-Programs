...
def read_file(dir_name, file_path):
    file_prefix = file_path.split(".txt")[0]
    image_file_name = "{}.jpg".format(file_prefix)
    img = Image.open("{}/{}".format("test", image_file_name))
    w, h = img.size
    print(image_file_name)
    txt_file_path = dir_name+'/'+ANNOTATIONS_DIR_PREFIX+'/'+file_path
